...
export function StaffPage() {
  ...
  const copy = locale === "ru"
    ? {
        ...
        removeDescription: "Все сессии админки завершатся, роли и MFA будут удалены. Отдельный аккаунт покупателя, даже с тем же email, не затрагивается.",
    ...
    : {
        ...
        removeDescription: "All admin sessions will end and roles and MFA will be removed. A separate customer account, even with the same email, is not affected.",
