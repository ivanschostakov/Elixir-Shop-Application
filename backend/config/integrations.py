...
BITRIX_PROMO_API_ENDPOINT = _env("BITRIX_PROMO_API_ENDPOINT")
BITRIX_PROMO_API_TOKEN = _env("BITRIX_PROMO_API_TOKEN")
BITRIX_PROMO_API_TIMEOUT_SECONDS = _int_env("BITRIX_PROMO_API_TIMEOUT_SECONDS", 10)
