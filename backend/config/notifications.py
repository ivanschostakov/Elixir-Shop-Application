...
COMMUNITY_NOTIFICATION_SCAN_INTERVAL_SECONDS = _float_env("COMMUNITY_NOTIFICATION_SCAN_INTERVAL_SECONDS", 5)
...
NOTIFICATION_REVIEW_REMINDER_AFTER_DAYS = _int_env("NOTIFICATION_REVIEW_REMINDER_AFTER_DAYS", 3)
