...
class AppPromo(Base, IdPkMixin, TimestampMixin):
    ...
    source_kind: Mapped[str] = mapped_column(String(length=SOURCE_KIND_MAX_LENGTH), nullable=False, default="app")
    ...
    stacking_policy: Mapped[str] = mapped_column(String(length=SOURCE_KIND_MAX_LENGTH), nullable=False, default="exclusive")
