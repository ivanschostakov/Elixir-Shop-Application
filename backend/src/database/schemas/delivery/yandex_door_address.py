...
class YandexDoorAddressBase(BaseModel):
...
class YandexDoorAddressCreate(YandexDoorAddressBase):
    pass


class YandexDoorAddressUpdate(BaseModel):
...
class YandexDoorAddressRead(YandexDoorAddressBase):
