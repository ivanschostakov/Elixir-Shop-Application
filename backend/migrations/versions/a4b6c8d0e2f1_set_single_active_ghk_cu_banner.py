...
def upgrade() -> None:
    ...
    op.execute(
        sa.text(
            ...
            image_path="/media/banners/ghk-cu-banner.jpg",
...
def downgrade() -> None:
    ...
    op.execute(sa.text("DELETE FROM banners WHERE image_path = :image_path").bindparams(image_path="/media/banners/ghk-cu-banner.jpg"))
