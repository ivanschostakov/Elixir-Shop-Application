    ...
    const footerItems = [
        {
            ...
            icon: <HomeIcon color={pathname === ROUTES.home ? accentPalette.primary : colors.mutedText} />,
        ...
        },
        {
            ...
            icon: <DiscoverIcon color={pathname === ROUTES.discover ? accentPalette.primary : colors.mutedText} />,
        ...
        },
        {
            ...
            icon: <SmileBubbleIcon color={pathname === ROUTES.chat ? accentPalette.primary : colors.mutedText} />,
        ...
        },
        {
            ...
            icon: (
                <View style={stickyFooterStyles.iconWrap}>
                    <BasketIcon color={pathname === ROUTES.basket ? accentPalette.primary : colors.mutedText} />
        ...
        },
        {
            ...
            icon: <ProfileIcon color={pathname === ROUTES.profile ? accentPalette.primary : colors.mutedText} />,
