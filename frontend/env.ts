...
const appIntegrityDevToken =
    process.env.EXPO_PUBLIC_APP_INTEGRITY_DEV_TOKEN?.trim() ||
    optionalString(extra?.appIntegrity?.devToken)
...
export const APP_INTEGRITY_DEV_TOKEN = appIntegrityDevToken || null
